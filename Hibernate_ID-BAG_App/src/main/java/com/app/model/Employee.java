...
public class Employee {
	...
	@ElementCollection
	@CollectionTable(name = "EMPPROJ_IDBAG_TAB",joinColumns = @JoinColumn(name="EID"))
	@CollectionId(columns = @Column(name = "UNQID"),generator = "abc",type = @Type(type = "int"))
	@Column(name = "DATA")
